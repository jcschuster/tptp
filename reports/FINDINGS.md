...
|---|---|---|---|
| [1](#1-syn000_2p-writes-introduced2) | `SYN000_2.p` writes `introduced/2` | TPTP | Unreported |
| [2](#2-syn0002p-uses-an-undeclared-symbol) | `SYN000^2.p` uses the undeclared `qll` | TPTP | Unreported |
| [3](#3-the-literal-unknown-source-is-also-a-name) | `unknown` is both a `<source>` literal and a `<name>` | TPTP, cosmetic | Unreported |
...
| [7](#7-the-pages-txf-paragraph-omits-distinct) | The language page's TXF paragraph omits `$distinct` | TPTP, cosmetic | Unreported |
| [8](#8-a-miscounted-number-of-x-terms-header) | `SYO561_1.p`'s `Number of X terms` header miscounts | TPTP | Unreported |
